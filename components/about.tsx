...
export const metadata: Metadata = {
  title: "About Me | Tufail",
  description:
    "Learn more about Tufail, a B2B growth and digital marketing specialist focused on predictable pipeline creation.",
};
      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <div className="md:w-1/2 space-y-6">
            ...
            <div className="pt-4">
              <a href="/Tufail_ahmad.pdf" download>
